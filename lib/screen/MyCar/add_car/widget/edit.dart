...
class EditCar extends StatefulWidget {
  ...
  final String id;
  const EditCar({super.key, required this.addCarModels, required this.id});
...
class _EditCarState extends State<EditCar> {
  ...
  late final platNumberController =
      TextEditingController(text: widget.addCarModels.plateNumber!);
  late final paintingController =
      TextEditingController(text: widget.addCarModels.painting!);
  ...
  @override
  void initState() {
    addCarController.brandIndex.value = widget.addCarModels.brandIndex!;
    addCarController.modelIndex.value = widget.addCarModels.modelIndex!;
    addCarController.colorIndex.value = widget.addCarModels.colorIndex!;
    super.initState();
  }
            ...
            child: Directionality(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Obx(() {
                      return AddCarModel(
                        addCarModels: widget.addCarModels,
                        brand: () {
